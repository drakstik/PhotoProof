...
func main() {
	...
	*/
	...
	image := camera.CreateImage(N, true, "", 0)
	// Simulating taking a picture with secure camera
	// image := CreateImage(N, true, "", 0)
	...
	a := [3][3]frontend.Variable{{1, 2, 3}, {4, 5, 6}, {7, 8, 9}} // A 3x3 array of frontend.Variable

	b := [3][3]frontend.Variable{{1, 2, 3}, {4, 5, 6}, {7, 8, 9}} // A 3x3 array of frontend.Variable
